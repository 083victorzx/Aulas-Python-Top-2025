...
# Jogador
jogador = pygame.Rect(100, 500, 40, 40)
cor_jogador = (0, 128, 0)

# Configurações iniciais do jogo
velocidade_jogador = 10
velocidade_obstaculos = 15
freq_obstaculos = 20  # Fase 1: menor frequência = mais difícel
cor_fundo = (50, 50, 50)
...
duracao_fase = 15  # duração de cada fase em segundos
...
while rodando:
    ...
    if fase_atual > ultima_fase:
        ...
        velocidade_obstaculos += 2  # aumenta a velocidade dos obstáculos
        velocidade_jogador += 1      # jogador também fica um pouco mais rápido
